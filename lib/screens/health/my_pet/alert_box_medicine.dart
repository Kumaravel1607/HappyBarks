...
class AlertBoxMedicine extends StatefulWidget {
  AlertBoxMedicine({Key? key}) : super(key: key);

  @override
  State<AlertBoxMedicine> createState() => _AlertBoxMedicine();

}

class _AlertBoxMedicine extends State<AlertBoxMedicine> {
