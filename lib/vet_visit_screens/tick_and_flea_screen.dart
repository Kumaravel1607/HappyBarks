...
class TickAndFleaScreen extends StatelessWidget {
   TickAndFleaScreen({Key? key}) : super(key: key);

  List<String> tickAndFleaDate = [
    "24/5/2023",
    "4/6/2023",
  ];
  List<String> tickAndFleaStatus = [
    "Done",
    "Due",
  ];
  List<String> tickAndFleaTitle = [
    "Tick & Flea",
    "Tick & Flea",
  ];
          ...
          children: [
            ...
            ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                return _buildVetVisitsList(tickAndFleaTitle[index],tickAndFleaDate[index],
                    tickAndFleaStatus[index], "Edit");
  ...
  Widget _buildVetVisitsList(String tickAndFleaTitle, String tickAndFleaDate,
      String tickAndFleaStatus, String edit,) {
    return Container(
